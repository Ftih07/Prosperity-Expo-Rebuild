    ...
    <div class="error-content">
        ...
        <div class="error-message">
            ...
            <p class="error-description">
                It appears that the page you are looking for has been moved, deleted, or never existed.
                Don't worry, let us guide you back to the right path!
            </p>
        </div>
...
<style>
    ...
    * {
    ...
    .glitch-text {
        ...
        color: #fff;
        position: relative;
        text-shadow: 0.05em 0 0 var(--light-blue), -0.03em -0.04em 0 var(--secondary-blue),
            0.025em 0.04em 0 #60a5fa;
    ...
    .btn::before {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(90deg, transparent, rgba(219, 234, 254, 0.3), transparent);
